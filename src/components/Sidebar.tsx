...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`h-screen ${isMobile ? 'fixed z-30' : 'sticky top-0'} transition-all duration-300 ease-in-out`}>
        <div 
          className={`flex flex-col h-full bg-white shadow-apple border-r border-gray-100 backdrop-blur-lg
                     transition-all duration-300 ease-in-out
                     ${isCollapsed ? (isMobile ? 'w-0 overflow-hidden' : 'w-[72px]') : 'w-64'}`}
        >
